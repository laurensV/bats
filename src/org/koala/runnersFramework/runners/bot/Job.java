...
public class Job implements Serializable {
	...
	/*runtimes per cluster and number of threads*/
	public HashMap<String, HashMap<Integer, Double>> runtimesMap;
	...
	public Job(List<String> args2, String executable, String jobID) {
		...
		runtimesMap = new HashMap<String, HashMap<Integer, Double>>();
