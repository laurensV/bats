...
public class DACHMixtureDistributedTruncatedBag extends Bag {
	...
	public DACHMixtureDistributedTruncatedBag(int size, 
	...
	public DACHMixtureDistributedTruncatedBag copy() {
		DACHMixtureDistributedTruncatedBag tmp = new DACHMixtureDistributedTruncatedBag(this.size, 
	...
	public static void main(String args[]) {
		...
		*/
		...
		DACHMixtureDistributedTruncatedBag bmnd = new DACHMixtureDistributedTruncatedBag(1000,
