...
public class Executor {
    ...
    void run() {
        ...
        try {
            ...
            } else if (whichMaster == 3) {
            	int type = (selectedSchedule + 1)/6;
                master = new SpotMaster(bot, schedules.get(selectedSchedule), type);
                System.out.println("Using " + Const.getString(type));
            }
        } catch (Exception ex) {
