...
public abstract class Cluster implements Serializable {
	...
	public void linearRegression(Cluster reference) {
		...
		/*System.out.println("this is " + alias);
		for (Job j : regressionPoints.values()) {
			System.out.println(j.jobID + " " + j.runtimes.get(alias));
		}
		System.out.println("Reference is " + reference.alias);
		for (Job j : reference.regressionPoints.values()) {
			System.out.println(j.jobID + " " + j.runtimes.get(reference.alias));
		}*/
